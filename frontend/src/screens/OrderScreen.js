...
import {getOrderDetails,payOrderDetails,deliveredOrderDetails} from '../actions/orderActions'
...
const OrderScreen = ({match,history}) => {
    ...
    const deliverHandler=()=>{
        dispatch(deliveredOrderDetails(order))
    }
                    ...
                    <Card>
                        <ListGroup variant='flush'>
                            ...
                            {userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
                                <ListGroup.Item>
                                    <Button type="button" className='btn btn-block' size="lg" onClick={deliverHandler}>Mark as Delivered </Button>
                                </ListGroup.Item>
                            )}
